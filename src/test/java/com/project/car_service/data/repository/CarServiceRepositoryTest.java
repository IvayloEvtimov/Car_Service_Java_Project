...
class CarServiceRepositoryTest {
	...
	void findCarServicesByCar_LicensePlateAndEmployee_PID() {
		...
		assertThat(carServiceRepository.findCarServicesByCar_LicensePlateAndEmployee_PID(licensePlate, PID)).isEqualTo(2);
	}
	...
	void findCarServicesByWrongCar_LicensePlateAndEmployee_PID() {
		...
		assertThat(carServiceRepository.findCarServicesByCar_LicensePlateAndEmployee_PID("ABC123", PID)).isEqualTo(0);
	}
	...
	void findCarServicesByCar_LicensePlateAndWrongEmployee_PID() {
		...
		assertThat(carServiceRepository.findCarServicesByCar_LicensePlateAndEmployee_PID(licensePlate, "89832982")).isEqualTo(0);
	}
	...
	void findCarServicesByWrongCar_LicensePlateAndWrongEmployee_PID() {
		...
		assertThat(carServiceRepository.findCarServicesByCar_LicensePlateAndEmployee_PID("ABC123", "89832982")).isEqualTo(0);
	}
	...
	void findAllBrands() {
		...
		carModel.setCarBrand(carBrand2);
		carModel.setYear(2020);
		testEntityManager.persistAndFlush(carModel);
